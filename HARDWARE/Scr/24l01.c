...
//__HAL_RCC_GPIOC_CLK_ENABLE();                             //使能端口A时钟
	...
	GPIO_InitStructure.Mode = GPIO_MODE_INPUT; //GPIO_Mode_IPU //GPIO_Mode_IPU
	...
	//__HAL_SPI_DISABLE(&SPI1_Handler);                             //能SPI1
	/*
...
u8 NRF24L01_TxPacket(u8 *txbuf)
{
  ...
  NRF24L01_CE_RESET;
	...
	while(HAL_GPIO_ReadPin(IRQ_GPIO_Port,IRQ_Pin)==GPIO_PIN_SET);
